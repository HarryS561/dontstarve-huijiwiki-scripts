...
function TileManager.RegisterTileRange(...) end

function TileManager.AddTile(tile_name, tile_range, tile_data, ground_tile_def, minimap_tile_def, turf_def)
    WORLD_TILES[tile_name] = tile_name
    Turfs[tile_name]=turf_def
end
